...
const Page = () => {
  ...
  const fetchServices = async () => {
    try {
      ...
      console.error("[Provider Dashboard] fetchServices error:", err);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600 font-medium">
              Manage your services and monitor real-time queue performance
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
          <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1">Manage and monitor your active services</p>
            </div>
            <Link href="/provider/servicesManagement">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-slate-100 cursor-pointer">
            <div className="flex items-center gap-4">
